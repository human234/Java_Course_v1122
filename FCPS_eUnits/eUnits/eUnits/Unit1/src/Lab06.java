...
public class Lab06 {
	...
	public static void task_01() { // go to the end of the row of beepers
	...
	public static void task_02() { // go to the beeper
	...
	public static void task_03() { // go to the wall
	...
	public static void task_04() { // go to the wall, pick up all the beepers (max one per pile)
	...
	public static void task_05() { // go to the wall, pick up all the beepers
	...
	public static void task_06() { // go to the end of the row of beepers, there is one gap
